...
public interface PersonInfoMapper {
     ...
     * @return
     */
    @Insert("insert into tb_caiji_info(caiji_name,start_time,end_time) values(#{person.personName},#{person.createTime},#{person.password})")
    Integer insertCaiji(@Param("person") PersonInfo personInfo);
