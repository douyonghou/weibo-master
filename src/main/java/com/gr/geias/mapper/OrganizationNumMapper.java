...
import com.gr.geias.entity.CityCnt;
import com.gr.geias.entity.OrganizationNum;
import com.gr.geias.entity.SexCnt;
import com.gr.geias.entity.TimeCnt;
...
public interface OrganizationNumMapper {
    ...
    List<SexCnt> getSextSum();
    List<CityCnt> getCItytSum();
    List<TimeCnt> getTimeSum();
