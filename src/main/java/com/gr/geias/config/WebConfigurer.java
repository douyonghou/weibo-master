...
public class WebConfigurer implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(adminInterceptor).addPathPatterns("/**")
                .excludePathPatterns("/page/index", "/page/echarts1", "/page/memberdaorulist", "/page/echarts4", "/page/echarts2", "/page/error", "/page/login", "/page/getinfo", "/page/welcome", "/page/personedit", "/page/toexcal", "/page/faseLogin")
                .excludePathPatterns("/init/getinit", "/init/getleve"
                        ...
                        , "/personinfo/addFase")
                .excludePathPatterns("/html/**", "/fonts/**", "/images/**", "/js/**", "/lib/**", "/css/**");
        registry.addInterceptor(superAdminInterceptor).addPathPatterns( "/page/organizationlist", "/page/collegeadd", "/page/collegeedit", "/page/person_1_list", "/page/person1add", "/page/person_1_edit", "/page/memberlist")
