...
class Weibo(object):
    ...
    def user_to_mysql(self):
        ...
        # 创建'user'表
        create_table = """
                CREATE TABLE IF NOT EXISTS tb_weibo_user (
        ...
        self.mysql_insert(mysql_config, 'tb_weibo_user', [self.user])
    ...
    def weibo_to_mysql(self, wrote_count):
        ...
        # 创建'weibo'表
        create_table = """
                CREATE TABLE IF NOT EXISTS tb_weibo_data (
                id varchar(20) NOT NULL,
        ...
        for w in info_list:
            ...
            weibo_list.append(w)
        # 在'weibo'表中插入或更新微博数据
        self.mysql_insert(mysql_config, 'tb_weibo_data', retweet_list)
        self.mysql_insert(mysql_config, 'tb_weibo_data', weibo_list)
    ...
    def write_data(self, wrote_count):
        print(self.write_mode,"000000000000000000000000000000000000000000")
        """将爬到的信息写入文件或数据库"""
